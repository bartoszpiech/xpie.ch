...
all: $(BUILD)/css/style.css $(BUILD)/fonts $(BUILD)/backgrounds/wallpaper.webp $(BUILD)/gallery $(BUILD)/badges $(BUILD)/song.opus $(BUILD)/cursor.png $(BUILD)/resume.pdf $(BUILD)/milo.pdf $(BUILD)/minisumo.pdf _stats.yaml $(ALL_HTML) $(BUILD)/feed.xml $(BUILD)/sitemap.xml $(BUILD)/robots.txt $(BUILD)/humans.txt $(BUILD)/CNAME
...
# ---- Milo PDF ----
$(BUILD)/milo.pdf: milo.pdf
	cp milo.pdf $(BUILD)/milo.pdf

# ---- Minisumo PDF ----
$(BUILD)/minisumo.pdf: minisumo.pdf
	cp minisumo.pdf $(BUILD)/minisumo.pdf
